      ...
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="lg:w-1/3 lg:h-screen lg:sticky lg:top-0 p-6 md:p-12 flex flex-col justify-center border-r border-white/5 bg-[#050505] z-10">
          <motion.div
            ...
            variants={fadeInUp}
          >
            <span className="text-xs text-orange-500 uppercase tracking-widest mb-4 block font-mono">
              Selected Works
            </span>
          ...
          {/* Interactive Filters with layoutId animation */}
            ...
            {["ALL", "PERSONAL", "FREELANCE", "COLLEGE"].map((cat) => {
              ...
              return (
                <button
                  ...
                  className={`relative flex items-center justify-between text-xs font-mono py-2.5 px-3.5 border transition-all text-left group cursor-pointer ${
                    isActive
                      ? "border-orange-500/40 text-orange-400 font-medium"
                ...
                >
                  ...
                  <span className="text-[10px] text-stone-600 z-10">{count > 0 ? `0${count}` : "00"}</span>
                </button>
              );
            })}
          </div>
          ...
          <AnimatePresence mode="wait">
            {filteredProjects.length === 0 ? (
              <motion.div
                ...
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
                className="min-h-[50vh] flex flex-col items-center justify-center p-12 text-center text-stone-500 font-mono text-sm"
              >
                ...
                {filteredProjects.map((project) => (
                  ...
                  >
                    <div className="w-full">
                      ...
                      {/* Image Container with Reveal & Spring */}
                      ...
                      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end border-t border-white/10 pt-6 gap-6">
                        ...
                        <div className="flex items-center gap-3 self-end sm:self-auto shrink-0">
                          ...
                          <motion.button
                            ...
                            className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-white group-hover:bg-white group-hover:text-black transition-all cursor-pointer"
                          >
