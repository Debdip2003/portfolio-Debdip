      ...
      <div className="max-w-screen-2xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        ...
        >
          ...
          <div className="relative z-10 p-8 md:p-10 h-full flex flex-col justify-end bg-gradient-to-t from-black/95 via-black/50 to-transparent">
            ...
            <div className="flex items-center gap-2 text-xs font-mono text-orange-400 group-hover:text-orange-300">
        ...
        {/* Stat Block 1 */}
        <div className="bg-stone-900/30 border border-white/5 p-8 flex flex-col justify-center items-center text-center hover:bg-stone-900/60 hover:border-white/15 transition-all">
